...
<%
    ...
    if(format!=null && !format.equals("json") && !format.equals("html"))
    ...
    try {
      ...
      if(raggioSensori==null || raggioBus==null || raggioSensori.equals(raggioServizi) && raggioBus.equals(raggioServizi))
        raggi = raggioServizi+"";
      else
