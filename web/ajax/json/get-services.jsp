...
/* ServiceMap.
   ...
   along with this program.  If not, see <http://www.gnu.org/licenses/>. */
    ...
    if(centroRicerca.startsWith("wkt:")) {
      ...
      coord = coordGeo;
    } else if(centroRicerca.startsWith("http:") || centroRicerca.startsWith("https:")) {
      if(centroRicerca.startsWith("https:"))
        centroRicerca="http:"+centroRicerca.substring(6);
      ...
      if(resultCoord.hasNext()) {
        ...
        coord = new String[] {bindingSetCoord.getValue("lat").stringValue(), bindingSetCoord.getValue("long").stringValue()};
      }
    }
    else{
    ...
    ServiceMap.println("get-services.jsp limit "+numeroRisultatiServizi);//Michela TODO
    ...
    String hlt = request.getParameter("highLevelType");
    
    try {
      serviceMapApi.queryLatLngServices(out, con, coord, categorie, textFilter,raggioServizi,raggioServizi,raggioServizi,numeroRisultatiServizi,numeroRisultatiServizi,numeroRisultatiServizi,null, cat_servizi, false, inside, true, fullCount, value_type, graphUri, null, apiKey, model, hlt);
